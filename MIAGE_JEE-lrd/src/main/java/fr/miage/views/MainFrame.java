...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void onTextChange(){
        try {
            Long i = Long.parseLong(idTextField.getText());
            if(!presentationPosteTextField.getText().isEmpty() && !presentationEntrepriseTextField.getText().isEmpty() || this.action != UseCase.DemandeCompetenceEquipe)
    ...
    private void initComponents() {
        ...
        statutComboBox.setModel(new javax.swing.DefaultComboBoxModel<Statut>(new Statut[] {Statut.Accepte, Statut.EnAttente, Statut.Refuse}));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(gérerCandidaturesbutton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void validateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validateButtonActionPerformed
        ...
        switch (this.action){
            ...
            case DemandeCompetenceEquipe:
                ...
                if(result == 0)
                    infoText.setText("<html>La demande de compétence n\'a pas été trouvée dans la base de données</html>");
                else
